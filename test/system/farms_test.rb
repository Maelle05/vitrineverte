...
class FarmsTest < ApplicationSystemTestCase
  ...
  test "creating a Farm" do
    ...
    fill_in "City", with: @farm.city
    fill_in "Description", with: @farm.description
    fill_in "Email", with: @farm.email
    fill_in "Hours", with: @farm.hours
    fill_in "Name", with: @farm.name
    fill_in "Payment", with: @farm.payment
    fill_in "Phone", with: @farm.phone
    fill_in "User", with: @farm.user_id
    fill_in "Zipcode", with: @farm.zipcode
